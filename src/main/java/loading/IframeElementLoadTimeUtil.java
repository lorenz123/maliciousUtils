...
import shared.AppUtil;

import java.util.concurrent.TimeoutException;

import static loading.ExceedLoadTimeUtil.exceedExpectedLoadTime;
...
public class IframeElementLoadTimeUtil {
    ...
    public static WebElement getIframeElementLoadTime(WebDriver driver, String selector, ElementType type) throws TimeoutException {
